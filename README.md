...
## 🌍 Overview
NBO-AirPulse is a data analytics project designed to validate the "Environmental" pillar of ESG in Nairobi. Using real-time data from the Nairobi City County Public Portal and historical data (2022-2026), this project tracks PM₂.₅ (Fine Particulate Matter) and NO₂ (Nitrogen Dioxide) within urban sensors.
